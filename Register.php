        ...
        <div class="registration-form">
            ...
            <form method="POST" action="registerprocess.php">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="femail" id="email" placeholder="Enter your valid email" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="fadd" id="address" rows="3" placeholder="Enter your complete address"></textarea>
                </div>
